            ...
            <table class="table table-hover caption-top">
                ...
                <tbody>
                    @foreach ($wood as $item)
                        <tr data-toggle="modal" data-target="#DGC_{{ $item->id }}" >
                            ...
                            {{-- SỬA LỊCH --}}
                            <div class="modal fade" id="DGC_{{ $item->id }}" tabindex="-1" role="dialog"
            ...
            <table class="table table-hover caption-top">
                ...
                <tbody>
                    ...
                    <tr @if ($today != $item->date_book) style="background-color: #fffe0045" @endif>
                        <td data-toggle="modal" data-target="#DGCDP_{{ $item->id }} " data-toggle="tooltip"
                        ...
                        <td data-toggle="modal" data-target="#DGCDPS_{{ $item->id_cus }}" data-toggle="tooltip"
                        ...
                        <div class="modal fade" id="DGCDP_{{ $item->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header text-center d-block">
                        ...
                        {{-- SỬA LỊCH ĐÃ PHÂN --}}
                        <div class="modal fade" id="DGCDPS_{{ $item->id_cus }}" tabindex="-1" role="dialog"
                            aria-labelledby="modelTitleId" aria-hidden="true">
