<div class="row mb-1" id="lichXD">
    <div class="col-4 card colo-blue">
        <h5 class="title-lich">LỊCH XÂY DỰNG</h5>
    </div>
        ...
        <div class="card widget-content colo-blue ">
            <div class="widget-content-wrapper ">
                ...
                <div class="widget-content-right">
                    <div class="text-danger text-count">
                        <span>
                            <div id="work_no_build_distribution">0</div>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="card widget-content colo-blue ">
            <div class="widget-content-wrapper ">
                ...
                <div class="widget-content-right">
                    <div class="text-danger text-count">
                        <span>
                            <div id="work_build_distribution">0</div>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="card widget-content colo-blue ">
            <div class="widget-content-wrapper ">
                ...
                <div class="widget-content-right">
                    <div class="text-danger text-count">
                        <span>
                            <div id="work_build_cancle">0</div>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-hover caption-top">
                ...
                <tbody>
                    @foreach ($build as $item)
                        <tr data-toggle="modal" data-target="#BULC_{{ $item->id }}" onclick="coppyText()"
                            id="myText">
                            ...
                            {{-- SỬA LỊCH --}}
                            <div class="modal fade" id="BULC_{{ $item->id }}" tabindex="-1" role="dialog"
            ...
            <table class="table table-hover caption-top">
                ...
                <tbody>
                    ...
                    <tr @if ($today != $item->date_book) style="background-color: #fffe0045" @endif>
                        <td data-toggle="modal" data-target="#BULCDP_{{ $item->id }} " data-toggle="tooltip"
                        ...
                        <td data-toggle="modal" data-target="#BULCDPS_{{ $item->id_cus }}" data-toggle="tooltip"
                        ...
                        <div class="modal fade" id="BULCDP_{{ $item->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header text-center d-block">
                        ...
                        {{-- SỬA LỊCH ĐÃ PHÂN --}}
                        <div class="modal fade" id="BULCDPS_{{ $item->id_cus }}" tabindex="-1" role="dialog"
                            aria-labelledby="modelTitleId" aria-hidden="true">
