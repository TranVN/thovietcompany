<div class="row mb-1" id="lichDN">
    <div class="col-4 card colo-blue">
        <h5 class="title-lich">LỊCH ĐIỆN NƯỚC</h5>
        ...
        <div class="card widget-content colo-blue">
            <div class="widget-content-wrapper ">
                ...
                <div class="widget-content-right">
                    <div class="text-danger text-count">
                        <span>
                            <div id="work_no_elec_distribution">0</div>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="card widget-content colo-blue">
            <div class="widget-content-wrapper ">
                ...
                <div class="widget-content-right">
                    <div class="text-danger text-count">
                        <span>
                            <div id="work_elec_distribution">0</div>
                        </span>
                    </div>
                </div>
            </div>
