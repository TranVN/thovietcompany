<div class="row mb-1" id="lichDL" >
    <div class="col-4 card colo-blue">
        <h5 class="title-lich">LỊCH ĐIỆN LẠNH</h5>
    </div>
        ...
        <div class="card widget-content colo-blue ">
            <div class="widget-content-wrapper ">
                ...
                <div class="widget-content-right">
                    <div class="text-danger text-count">
                        <span>
                            <div id="work_no_air_distribution">0</div>
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="card widget-content colo-blue ">
            <div class="widget-content-wrapper ">
                ...
                <div class="widget-content-right">
                    <div class="text-danger text-count">
                        <span>
                            <div id="work_air_distribution">0</div>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12 col-lg-5 card r-border">
        <div class="table-responsive-xxl ">
            <table class="table table-hover caption-top">
                ...
                <tbody>
                    @foreach ($air as $item)
                        <tr data-toggle="modal" data-target="#DNL_{{ $item->id }}" >
                            ...
                            {{-- SỬA LỊCH --}}
                            <div class="modal fade" id="DNL_{{ $item->id }}" tabindex="-1" role="dialog"
    ...
    <div class="col-12 col-lg-7 card r-border">
        <div class="table-responsive-xxl ">
            <table class="table table-hover caption-top">
                ...
                <tbody>
                    @foreach ($airHas as $item)
                        <tr @if ($today != $item->date_book) style="background-color: #fffe0045" @endif>
                            <td data-toggle="modal" data-target="#DLCDP_{{ $item->id }} " data-toggle="tooltip"
                            ...
                            <td data-toggle="modal" data-target="#DLCDPS_{{ $item->id_cus }}" data-toggle="tooltip"
                            ...
                            <div class="modal fade" id="DLCDP_{{ $item->id }}" tabindex="-1" role="dialog"
                                aria-labelledby="modelTitleId" aria-hidden="true">
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header text-center d-block">
                            ...
                            {{-- SỬA LỊCH ĐÃ PHÂN --}}
                            <div class="modal fade" id="DLCDPS_{{ $item->id_cus }}" tabindex="-1" role="dialog"
                                aria-labelledby="modelTitleId" aria-hidden="true">
